...
public class itemController {
    ...
    public ResponseEntity<Resource> downloadAttch(@PathVariable Long itemId) throws MalformedURLException {
        ...
        String contentDisposition = "attachement; filename=\"" + encodedUploadFileName + "\"";
